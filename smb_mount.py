"""Per-host CIFS mount under ephemeral dir: mount → use → umount (refcount)."""
        ...
        try:
            ...
            if r.returncode != 0:
                ...
                if _sudo_mount() and (
                    ...
                    msg += (
                        " — sudo에 mount/umount NOPASSWD 필요 (/usr/bin/mount 등). "
                        "또는 ROUTERCUT_MOUNT_USE_SUDO=0 로 일반 mount 시도."
                    )
                return False, msg
